...
| **`fortress-truth`** | The cleared/uncleared claim register. Installs and runs `claim_lint.py`, which fails on unsourced claim-shaped language: bare numbers/percentages, superlatives, comparatives, absolutes, testimonial-shaped quotes. Bans the motte-and-bailey rhetorical move outright. No waivers. |
